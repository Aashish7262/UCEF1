  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative w-full max-w-3xl rounded-3xl p-[2px]
        ...
        <div className="rounded-3xl bg-black/70 backdrop-blur-xl flex flex-col overflow-hidden">
          ...
          <div className="flex-1 px-6 py-5 space-y-4 overflow-y-auto">
            ...
            {loading && (
              <div className="bg-white/10 text-gray-300 px-4 py-2 rounded-2xl w-fit animate-pulse border border-white/10">
                Typing...
              </div>
            )}
          </div>
          ...
          <div className="px-4 py-3 border-t border-white/10 flex gap-2">
            <input
              ...
              className="flex-1 rounded-xl px-4 py-2 outline-none text-sm
