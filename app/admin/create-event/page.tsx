...
export default function CreateEventPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative w-full max-w-xl rounded-3xl p-[2px]
        ...
        <div className="rounded-3xl bg-black/70 backdrop-blur-xl p-10">
          ...
          {message && !createdEventId && (
            <div className="mt-6 bg-green-500/10 border border-green-500/30 text-green-300 text-sm rounded-xl px-4 py-3 text-center">
              {message}
            </div>
          )}
