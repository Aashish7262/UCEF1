    ...
    try {
      const res = await fetch("/api/evaluations/score", {
        ...
        body: JSON.stringify({
          ...
          presentation,
          feedback,
          userId, // ✅ added for secure backend
        }),
      });
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {submissions.map((submission) => (
          ...
          >
            ...
            <div className="text-sm text-blue-400 space-y-1 mb-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-purple-500 text-black rounded-xl"
            >
              Evaluate This Team
            </button>
          </div>
        ...
        <div className="mt-16 border-t border-white/10 pt-10">
          ...
          <div className="flex gap-4 mb-8">
            <button
              ...
              className="px-6 py-2 bg-blue-500 text-black rounded-xl"
            >
              View Leaderboard
            </button>
